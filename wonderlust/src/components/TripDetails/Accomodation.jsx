...
const desc = isAccommodation ? "Location Name " : <Button className="p-2 bg-blue-600 text-white rounded-md" onClick={() => setSidebarOpen(true)}>
        Open Sidebar
      </Button>
const data = { title: "Accommodation", date: "Jan 12, 2024", description: desc }
    return ( 
    <Timeline.Item>
