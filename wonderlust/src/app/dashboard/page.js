  ...
  return (
    <div className=" min-h-screen font-sans" style={{backgroundColor:"var(--accent-1)"}}>
      <main className="max-w-6xl mx-auto p-4 " >
        ...
        <TripForm buttonValue="+ Create New Trip" title="Create New Trip" actionTitle="Create Trip" action="new" />
        </div>
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex space-x-4">
                  ...
                  <TripForm buttonValue={<FaEdit className="text-xl" />} title="Edit Trip" actionTitle="Save Trip" action="edit" id= {trip.tripObjId} tripInfo={trip}/>
                  </div>
