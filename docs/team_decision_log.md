...
| No. | Question/Option | Umesh | Suhani | Teammate name | Teammate name | Teammate name | Teammate name |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
|   |	- BE Language | Node | Node  | | | | |
|   |	- FE Language | JavaScript| JavaScript | | | | |
|   |	- FE Framework | React/Next.js | Nextjs | | | | |
